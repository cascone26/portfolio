    ...
    <div className="overflow-hidden py-4 relative select-none">
      ...
      <div className="marquee-track flex gap-3">
        {[...tech, ...tech].map((name, i) => (
          <span
            key={i}
            className="marquee-pill shrink-0 px-5 py-2 rounded-full border border-[var(--border)] bg-[var(--tint-02)] text-sm text-muted whitespace-nowrap transition-colors duration-300 hover:border-accent/30 hover:text-accent-light"
          >
            {name}
          </span>
        ))}
