        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-muted leading-relaxed">
              <p>
                ...
                elementary education and Christian teaching, graduating in April
                2027.
              </p>
              <p>
                On the side, I build websites and AI tools for small businesses.
                I taught myself web development and have shipped a live SaaS
                product (LessonDraft) with real users, real payments, and real AI
                integration. I&apos;m not an agency — I&apos;m one person who
          ...
          <div>
            ...
            <div className="space-y-4 text-muted leading-relaxed">
              ...
              <p>
                I speak plain English, not tech jargon. I build things that work,
                not things that impress other developers. And I charge fair
                prices because I know what it&apos;s like to work within a
                budget.
              </p>
            </div>
          </div>
