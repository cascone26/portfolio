...
export default function FitnessPage() {
  const schema = {
    ...
    "@type": "Service",
    name: "Websites for Gyms & Fitness Studios in Kansas City",
    description: "Custom websites for gyms, personal trainers, yoga studios, and fitness businesses in the Kansas City area.",
    provider: { "@type": "LocalBusiness", name: "BuiltSimple", url: "https://builtsimple.dev" },
    areaServed: { "@type": "City", name: "Kansas City" },
    serviceType: "Web Development for Fitness Businesses",
  };
