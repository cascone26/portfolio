...
export default function SalonsPage() {
  const schema = {
    ...
    "@type": "Service",
    name: "Websites for Salons & Beauty Studios in Kansas City",
    description: "Custom websites for salons, barbershops, spas, and beauty studios in the Kansas City area.",
    provider: { "@type": "LocalBusiness", name: "BuiltSimple", url: "https://builtsimple.dev" },
    areaServed: { "@type": "City", name: "Kansas City" },
    serviceType: "Web Development for Salons",
  };
